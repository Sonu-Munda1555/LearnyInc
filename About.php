            ...
            <div class="team-row" id="team-row">
                <div class="team-cols">
                    <div class="profile-img">
                        <img src="./assets/img/SonuMunda.jpeg" alt="Sonu Munda">
                    </div>
                    <div class="member-name">
                        <h3 class="text-uppercase text-center">Sonu Munda</h3>
                    </div>
                ...
                <div class="team-cols">
                    <div class="profile-img">
                        <img src="./assets/img/GaneshKumar.jpeg" alt="Ganesh Kumar">
                    </div>
                    <div class="member-name">
                        <h3 class="text-uppercase text-center">Ganesh Kumar</h3>
                    </div>
                    <div class="member-post">
                        <p class="text-uppercase text-center">
                            CO-Founder
